      ...
      <select onChange={(e) => getValue(e.target.value)}>
        {
          ...
          :
          <option label='4pm to 5:30pm - Add to waitinglist'>4pm to 5:30pm</option>
        } 
        {
          ...
          :
          <option label='4:30pm to 6pm - Add to waitinglist'>4:30pm to 6pm</option>
        } 
        {
          ...
          :
          <option label='5pm to 6:30pm - Add to waitinglist'>5pm to 6:30pm</option>
        }

        {
          ...
          :
          <option label='5:30pm to 7pm - Add to waitinglist'>5:30pm to 7pm</option>
        }
        {
          ...
          :
          <option label='6pm to 7:30pm - Add to waitinglist'>6pm to 7:30pm</option>
        }  
        {
          ...
          :
          <option label='6:30pm to 8pm - Add to waitinglist'>6:30pm to 8pm</option>
        }  

        {
          ...
          :
          <option label='7pm to 8:30pm - Add to waitinglist'>7pm to 8:30pm</option>
        }  
        
        {
          ...
          :
          <option label='7:30pm to 9pm - Add to waitinglist'>7:30pm to 9pm</option>
        }

        {
          ...
          :
          <option label='8pm to 9:30pm - Add to waitinglist'>8pm to 9:30pm</option>
        } 
        {
          ...
          :
          <option label='8:30pm to 10pm - Add to waitinglist'>8:30pm to 10pm</option>
        } 
        {
          ...
          :
          <option label='9pm to 10:30pm - Add to waitinglist'>9pm to 10:30pm</option>
        } 
        {
          ...
          :
          <option label='9:30pm to 11pm - Add to waitinglist'>9:30pm to 11pm</option>
        } 
        {
          ...
          :
          <option label='10pm to 11:30pm - Add to waitinglist'>10pm to 11:30pm</option>
        } 
